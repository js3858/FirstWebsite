...
//shareButton에서 addEventListener를 실행한다
// (("event, 사건"), 코드가 실행하는 명령)

function calculator(){ //명령어 calculator
    const nameValue = document.querySelector("#name_value"); //nameValue라는 변수는 calculator 명령어 안에서만 사용
    ...
    if (yearValue_int%12 == 0) {yearResult.innerText = '원숭이띠';} // 태어난 해를 12로 나눴을 때 나머지가 0이면 원숭이의 해
    ...
    else if  (yearValue_int%12 == 8) {yearResult.innerText = '강한 용띠';}
        ...
        // 뱀 원숭이 말 양 돼지 닭 개 쥐 소 호랑이 토끼 용 뱀 12가지 동물
    }, 1000 ); // 1초
